...
import userStateReducer, {userStateInitialState} from './user-state'; //codingsprite
...
const guiInitialState = {
    ...
    userState: userStateInitialState//codingsprite
};
...
const guiReducer = combineReducers({
    ...
    userState: userStateReducer//codingsprite
});
